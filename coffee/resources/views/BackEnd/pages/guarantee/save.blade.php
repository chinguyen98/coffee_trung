...
@section('content')
    <div class="container-fluid my-5">
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="{{Route('admin.guaranteeSave')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="title">Thời gian bảo hành</label>
                        <input type="text" class="form-control" name="time" minlength="5" maxlength="20">
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <button class="btn btn-primary btn-round" type="submit">
                    <i class="material-icons">add_box</i> Thêm Bảo Hành
                </button>
                </form>
            </div>
        </div>
