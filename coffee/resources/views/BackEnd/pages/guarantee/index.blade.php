...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 d-flex justify-content-end">
            <a href="{{Route('admin.guaranteeSave')}}" class="btn btn-primary btn-round"  style="color: white;">
                <i class="material-icons">add_circle_outline</i> Thêm Bảo Hành
            </a>
        </div>
    </div>
    <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#myTable').DataTable({
                ...
                ajax: '{{ Route('admin.guaranteeFetchIndex') }}',
                columns:[
            ...
            function showNotification(from, align,message){
                ...
                update=$(this).val();
                let url ="{{Route('admin.guaranteeUpdateStatus',':id')}}";
