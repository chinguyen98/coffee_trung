...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 d-flex justify-content-end">
            <a href="{{Route('admin.originSave')}}" class="btn btn-primary btn-round"  style="color: white;">
                <i class="material-icons">add_circle_outline</i> Thêm Xuất Xứ
            </a>
        </div>
    </div>
    <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#myTable').DataTable({
                ...
                ajax: '{{ Route('admin.originFetchIndex') }}',
                columns:[
            ...
            $("#btn-confirm").click(function (){
                let url ="{{Route('admin.originDelete',':id')}}";
            ...
            //end xóa dữ liệu
             ...
             function showNotification(from, align,message){
                ...
                update=$(this).val();
                let url ="{{Route('admin.originUpdateStatus',':id')}}";
