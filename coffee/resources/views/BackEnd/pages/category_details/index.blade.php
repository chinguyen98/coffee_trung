...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 d-flex justify-content-end">
            <a href="{{Route('admin.categorydetailsSave',$id)}}" class="btn btn-primary btn-round"  style="color: white;">
                <i class="material-icons">add_circle_outline</i> Thêm Chi Tiết Thể Loại
            </a>
        </div>
    </div>
    <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#myTable').DataTable({
                ...
                ajax: '{{ Route('admin.categorydetailsFetchIndex',$id) }}',
                columns:[
            ...
            $("#btn-confirm").click(function (){
                let url ="{{Route('admin.categorydetailsDelete',':id')}}";
            ...
            //end xóa dữ liệu
             ...
             function showNotification(from, align,message){
                ...
                update=$(this).val();
                console.log(update);
                let url ="{{Route('admin.categorydetailsUpdateStatus',':id')}}";
